...
import { GuardColumnEditDialog } from './GuardColumnEditDialog';
...
export const GuardColumnTimeline = ({ guardColumns, onRefresh }: GuardColumnTimelineProps) => {
  const [editingColumn, setEditingColumn] = useState<GuardColumn | null>(null);
  ...
  return (
    <>
                      ...
                      <div className="flex items-center justify-between mb-3">
                        ...
                        <div className="flex items-center space-x-2">
                          ...
                          <Button
                            size="sm"
                            variant="ghost"
                            onClick={() => setEditingColumn(guardColumn)}
                          >
      ...
      {editingColumn && (
        <GuardColumnEditDialog
          guardColumn={editingColumn}
          isOpen={true}
